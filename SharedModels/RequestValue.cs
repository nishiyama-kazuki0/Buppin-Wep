namespace SharedModels
{
    public class RequestValue
    {
        ...
        /// </summary>
        public Dictionary<string, ArgumentValue> ArgumentValues { get; set; } = new();
        ...
        /// </summary>
        public SortedList<int, List<ArgumentValue>> ArgumentDataSet { get; set; } = new();
        /// <summary>
        ...
        /// </summary>
        public string TagetTableNameForDataSet { get; set; } = string.Empty;
        /// <summary>
        ...
        {
            TagetTableNameForDataSet = tableNameForDataSet;
        ...
        public RequestValue Clone()
        {
            ...
            {
                RequestProgramName = RequestProgramName,
                TagetTableNameForDataSet = TagetTableNameForDataSet,
