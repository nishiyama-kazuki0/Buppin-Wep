...
{
    public class ChildBaseService
    {
        internal bool BasePageInitilizing = false;

        //TODO メインレイアウトにプロパティを持たせるよりは、個別のコンポーネント対応があるので、全体でIsHandyを共有できるこのクラスを参照する方がよいのでは？
        //TODO ハンディ用のにデータグリッドのフォントサイズを分ける必要があるので用意。ハンディ用のデータグリッドコンポーネントを作成するなど、検討は必要。
        /// <summary>
        /// IsHandy
        /// </summary>
