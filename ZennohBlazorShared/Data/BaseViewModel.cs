...
namespace ZennohBlazorShared.Data
{
    ...
    public class BaseViewModel
    {
        ...
        public string StrFirstRireki()
        {
            if (Rireki.Count > 0)
            {
                Rireki = new List<string>() { Rireki[0] };
            }
            return string.Join(",", Rireki);
        }
        ...
        public string GetFirstRirekiUrl()
        {
            ...
            else if (className.Equals(typeof(StepItemMovePalletSearch).Name) ||
        ...
        {
            return (val is null) ? new List<string>() : val.Split(",").ToList();
        }
        #endregion
    }
}
