...
namespace ZennohBlazorShared.Pages
{
    ...
    /// 出荷進捗照会 コーナー別
    /// </summary>
    public partial class TabItemShipmentsProgressCorners : TabItemBase
    {
        public const string STR_ATTRIBUTE_GRID_ALL = "AttributesGridAll";
        public const string STR_GRID_VIEW_NAME = "VW_出荷進捗_コーナー別";
        public const string STR_GRID_ALL_VIEW_NAME = "VW_出荷進捗_コーナー別_全体進捗";
                    ...
                    if (attribute != null)
                    {
                        ...
                        switch (_componentsInfo[i].ValueObjectType)
                        {
                            ...
                            case (int)ComponentsInfo.EnumValueObjectType.VariableIndicator:
                                ...
                                if (null == type)
                                {
                                    type = typeof(TabItemShipmentsProgressCorners);
                                }
            ...
            try
            {
                ...
                if (_gridData != null && _gridData.Count() > 0)
                {
                    ...
                    if (_gridAllData != null && _gridAllData.Count() > 0)
                    {
                        ...
                        _gridAllData[0][STR_GRID_COL_PRG_引当進捗率] = _gridAllData[0][STR_GRID_COL_引当進捗率] = ComService!.GetPercent(dec引当済数, dec出荷予定数, 1); ;
                        _gridAllData[0][STR_GRID_COL_欠品数] = dec欠品数;
                        _gridAllData[0][STR_GRID_COL_ピック済数] = decピック済数;
                        _gridAllData[0][STR_GRID_COL_PRG_ピック進捗率] = _gridAllData[0][STR_GRID_COL_ピック進捗率] = ComService!.GetPercent(decピック済数, dec出荷予定数, 1);
                        _gridAllData[0][STR_GRID_COL_コーナー搬送済数] = decコーナー搬送済数;
                        _gridAllData[0][STR_GRID_COL_PRG_搬送進捗率] = _gridAllData[0][STR_GRID_COL_搬送進捗率] = ComService!.GetPercent(decコーナー搬送済数, dec出荷予定数, 1);
                    }
                }
