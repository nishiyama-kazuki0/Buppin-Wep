...
{
    /// <summary>
    /// パレットピック(倉庫別)/パレットNo.読取
    /// </summary>
    public partial class StepItemPickingPalletSearch : StepItemBase
    {
        ...
        public override async Task F4画面遷移(ComponentProgramInfo info)
        {
            ...
            // パレットピッキング【倉庫別】倉庫/ゾーン選択へ遷移
            NavigationManager.NavigateTo("picking_target_select");
        }
