...
{
    /// <summary>
    /// パレット照会/パレット№情報 店別仕分在庫
    /// </summary>
    public partial class StepItemSortingByStorePalletInventoryInquirySearch : StepItemBase
    {
        private StepItemSortingByStorePalletInventoryInquiryViewModel? model;
        ...
        {
            model = (StepItemSortingByStorePalletInventoryInquiryViewModel?)PageVm;
