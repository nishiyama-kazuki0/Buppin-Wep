...
namespace ZennohBlazorShared.Pages
{
    ...
    /// </summary>
    public partial class StepItemPickingTargetSelectByDeliveryZone : StepItemBase
    {
        ...
        public override async Task F1画面遷移(ComponentProgramInfo info)
        {
            ...
            // パレットピッキング（倉庫配送先別）画面に遷移
            NavigationManager.NavigateTo("picking_pallet_by_delivery");
        }
