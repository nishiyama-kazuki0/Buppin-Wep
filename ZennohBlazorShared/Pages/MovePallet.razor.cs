...
namespace ZennohBlazorShared.Pages
{
    ...
    /// パレット移動
    /// </summary>
    public partial class MovePallet : ChildPageBaseMobile
    {
        /// <summary>
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (model.IsRireki)
            {
                if (model.LastRireki.Equals(typeof(StepItemMovePalletInput).Name))
                {
            ...
            {
                new StepItemInfo() { Title = "ﾊﾟﾚｯﾄNo.読取", StepItem = new StepItemMovePalletSearch() },
