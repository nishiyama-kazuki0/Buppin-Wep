...
namespace ZennohBlazorShared.Pages
{
    ...
    /// パレット照会
    /// </summary>
    public partial class PalletInventoryInquiry : ChildPageBaseMobile
    {
        /// <summary>
        ...
        {
            StepItemPalletInventoryInquiryViewModel model = new()
            {
            ...
            {
                new StepItemInfo() { Title = "ﾊﾟﾚｯﾄNo.読取", StepItem = new StepItemPalletInventoryInquirySearch() },
                new StepItemInfo() { Title = "ﾊﾟﾚｯﾄ在庫明細", StepItem = new StepItemPalletInventoryInquiryDetail() },
            };
