...
namespace ZennohBlazorShared.Pages
{
    ...
    /// 残格納(倉庫別)
    /// </summary>
    public partial class RemainingStore : ChildPageBaseMobile
    {
        /// <summary>
        ...
        {
            StepItemRemainingStoreViewModel model = new()
            {
            ...
            {
                new StepItemInfo() { Title = "残格納確定", StepItem = new StepItemRemainingStorePick() }
            };
