...
namespace ZennohBlazorShared.Pages
{
    ...
    /// 出荷作業実績管理 作業者・ゾーン別
    /// </summary>
    public partial class TabItemProductivityShipmentsPersonsZone : TabItemBase
    {
        #region override
        ...
        public override async Task RefreshGridData(Dictionary<string, WhereParam> whereParam, string strViewName = "", string attributeName = STR_ATTRIBUTE_GRID, bool bInitSelect = false)
        {
            try
            {
                ...
                strArg += whereParam.ContainsKey("倉庫コード") ? ", @倉庫コード" : ", (null)";
                strArg += whereParam.ContainsKey("ゾーンコード") ? ", @ゾーンコード" : ", (null)";
