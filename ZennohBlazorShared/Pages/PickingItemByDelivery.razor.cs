...
namespace ZennohBlazorShared.Pages
{
    ...
    /// 摘取ピック(倉庫配送先別)
    /// </summary>
    public partial class PickingItemByDelivery : ChildPageBaseMobile
    {
        /// <summary>
        ...
        {
            StepItemPickingItemByDeliveryViewModel model = new()
            {
            ...
            {
                new StepItemInfo() { Title = "ﾊﾟﾚｯﾄNo.読取", StepItem = new StepItemPickingItemByDeliveryPallet() },
                new StepItemInfo() { Title = "品名選択", StepItem = new StepItemPickingItemByDeliveryProduct() },
                new StepItemInfo() { Title = "ﾋﾟｯｸ数入力", StepItem = new StepItemPickingItemByDeliveryPick() }
            };
