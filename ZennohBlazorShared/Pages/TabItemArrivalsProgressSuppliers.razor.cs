...
namespace ZennohBlazorShared.Pages
{
    ...
    /// 入荷進捗照会 出荷者別
    /// </summary>
    public partial class TabItemArrivalsProgressSuppliers : TabItemBase
    {
        public const string STR_ATTRIBUTE_GRID_ALL = "AttributesGridAll";
        public const string STR_GRID_VIEW_NAME = "VW_入荷進捗_出荷者別";
        public const string STR_GRID_ALL_VIEW_NAME = "VW_入荷進捗_出荷者別_全体進捗";
                    ...
                    if (attribute != null)
                    {
                        ...
                        switch (_componentsInfo[i].ValueObjectType)
                        {
                            ...
                            case (int)ComponentsInfo.EnumValueObjectType.VariableIndicator:
                                ...
                                if (null == type)
                                {
                                    type = typeof(TabItemArrivalsProgressSuppliers);
                                }
