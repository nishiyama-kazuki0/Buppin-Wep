...
namespace ZennohBlazorShared.Shared
{
    public partial class CompDropDownDataGrid : CompBase
    {
        ...
        [Parameter]
        public IEnumerable<ValueTextInfo> Data { get; set; } = new List<ValueTextInfo>();
        [Parameter]
        public string ModelName { get; set; } = string.Empty;

        [Parameter]
        public IEnumerable<string> InitialValues { get; set; } = new List<string>();

        public IEnumerable<string> _Values = new List<string>();
        [Parameter]
