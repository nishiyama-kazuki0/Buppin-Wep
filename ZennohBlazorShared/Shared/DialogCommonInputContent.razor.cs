...
namespace ZennohBlazorShared.Shared
{
    ...
    public partial class DialogCommonInputContent : IAsyncDisposable
    {
        ...
        /// 情報エリアコンポーネント
        /// </summary>
        protected List<List<CompItemInfo>> _infoItems = new();

        /// <summary>
        /// 入力エリアコンポーネント
        /// </summary>
        protected List<List<CompItemInfo>> _inputItems = new();
        ...
        /// </summary>
        [Parameter]
        public IList<ComponentsInfo> ComponentsInfos { get; set; } = new List<ComponentsInfo>();
        /// <summary>
        /// グリッドカラム定義
        /// </summary>
        [Parameter]
        public IList<ComponentColumnsInfo> Components { get; set; } = new List<ComponentColumnsInfo>();
        /// <summary>
        /// 初期データ
        /// </summary>
        [Parameter]
        ...
        /// <returns></returns>
        protected virtual async Task OnClickResultF1(object? sender)
        {
            // チェック
            if (false == バリデートチェック())
            {
        ...
        /// 情報エリア初期化
        /// </summary>
        protected virtual async Task InitInfoItemsAsync()
        {
            // クリア
            _infoItems.Clear();
        ...
        /// 明細項目初期化
        /// </summary>
        protected virtual async Task InitInputItemsAsync()
        {
            // クリア
            _inputItems.Clear();
