...
namespace ZennohBlazorShared.Shared
{
    ...
    public partial class ChildPageBaseMobile : ChildPageBase
    {
        ...
        public override async Task バイブレーション開始(ComponentProgramInfo info)
        {
            ...
            if (sysParams is not null)
            {
                onPeriod = sysParams.HT_DefaultVibrationOnPeriod;
                offPeriod = sysParams.HT_DefaultVibrationOffPeriod;
                repeatCount = sysParams.HT_DefaultVibrationReratCount;
            }
        ...
        protected bool IsPalletBarcode(string code)
        {
            bool ret = code.Length is
                ...
                SharedConst.LEN_PALLET_NO_BARCODE3;
            return ret;
        }
        ...
        protected bool IsLocationBarcode(string code)
        {
            bool ret = code.Length is
                ...
                not SharedConst.LEN_PALLET_NO_BARCODE3;
            return ret;
        }
        /// <summary>
