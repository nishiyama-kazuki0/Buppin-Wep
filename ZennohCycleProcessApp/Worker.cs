...
namespace ZennohCycleProcessApp
{
    public class Worker : BackgroundService
    {
        ...
        public Worker(ILogger<Worker> logger, IConfiguration configuration, HttpClient httpClient)
        {
            ...
            _httpComTimeout = configuration.GetValue<int>("HttpComTimeout");
            _httpClient.Timeout = TimeSpan.FromMilliseconds(_httpComTimeout);
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            async Task<bool> CheckResponseResultAsync(HttpResponseMessage response)
            {
                ...
                LogTo.Warning($"OK:response.IsSuccessStatusCode:{response.IsSuccessStatusCode}");
